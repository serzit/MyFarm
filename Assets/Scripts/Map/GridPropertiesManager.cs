...
public class GridPropertiesManager : SingletonMonoBehaviour<GridPropertiesManager>, ISaveable
{
    ...
    {
        GridPropertyDetails gridPropertyDetauls = GetGridPropertyDetails(xGrid, yGrid);

        if (gridPropertyDetauls == null)
        {
            return false;
        }
        else if (gridPropertyDetauls.daysSinceWatered > -1)
        {
            return true;
        }
        else
    ...
    public void DisplayPlantedCrop(GridPropertyDetails gridPropertyDetails)
    {
        if (gridPropertyDetails.seedItemCode > -1)
        {
            ...
            if (cropDetails != null)
            {
                ...
                Vector3 worldPosition = groundDecoration2.CellToWorld(new Vector3Int(
    ...
    private void InitialiseGridProperties()
    {
        ...
        foreach (SO_GridProperties so_GridProperties in so_gridPropertiesArray)
        {
            ...
            foreach (GridProperty gridProperty in so_GridProperties.gridPropertyList)
            {
                ...
                gridPropertyDetails = GetGridPropertyDetails(
    ...
    {
        if (GameObject.FindGameObjectWithTag(Tags.CropsParentTransform))
        {
    ...
    /// <summary>
    /// Returns the gridPropertyDetails at the gridlocation for the supplied dcitionary, or null if no properties exists at thath location
    /// </summary>
    ...
    public Crop GetCropObjectAtGridLocation(GridPropertyDetails gridPropertyDetails)
    {
        ...
        // Loop through collides to get crop game object
        Crop crop = null;
    ...
    /// <summary>
    /// for sceneName this method returns a Vector2Int with the grid dimensions for that scene or Vector2Int.zero if scene not foind
    /// </summary>
    ...
    public void ISaveableRestoreScene(string sceneName)
    {
        ...
        if (GameObjectSave.sceneData.TryGetValue(sceneName, out SceneSave sceneSave))
        {
            ...
            // get dictionary of bools - it exists since we create it in initialise
            ...
            {
                // grid property details found for the current scene destroy existing groud decoration
