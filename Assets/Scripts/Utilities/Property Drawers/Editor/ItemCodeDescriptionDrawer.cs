...
public class ItemCodeDescriptionDrawer : PropertyDrawer
{
    ...
    {
        // Change the returned property height to be double to cater for additional item code description that will draw
    ...
    {
        // using BegingProperty / EndProperty on the parent property mean that prefab override logic works on the entire property
    ...
    private string GetItemDescription(int itemCode)
    {
        ...
        so_itemList = AssetDatabase.LoadAssetAtPath(
            "Assets/Scriptable Objects Assets/Item/so_ItemList.asset",
