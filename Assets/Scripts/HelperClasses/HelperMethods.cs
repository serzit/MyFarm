...
public static class HelperMethods
{
    ...
    /// Returns true if at least one one found and the found components are returned in componentAtPositionList
    /// </summary>
    ...
    /// <summary>
    /// Get Components of type T at box with centre point and size and angle.
    /// return true if at least one found and the found components are returned in the list
    /// </summary>
