...
public class CropDetails
{
    ...
    public GameObject[] growthPrefab; // prefab to use when instatiating growth stages
    ...
    [ItemCodeDescription]
    public int[] cropProducedItemCode; // array of item code produced for the harvested crop
